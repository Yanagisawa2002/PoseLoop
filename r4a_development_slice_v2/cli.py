"""CLI for the corrected R4-A gray slice."""
...
def _parser() -> argparse.ArgumentParser:
    ...
    freeze.add_argument("--v4-receipt", type=Path, required=True)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.command == "plan":
        result = build_plan(
            ...
            scene_ids=[0, 1, 2],
            image_ids=[0],
            expected_target_count=173,
            maximum_compressed_bytes=536870912,
        ...
        result = build_prefreeze_receipt(
            ...
            catalog_path=args.catalog.resolve(),
            v4_receipt_path=args.v4_receipt.resolve(),
